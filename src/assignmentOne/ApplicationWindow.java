...
public class ApplicationWindow {
	...
	private void initialize() {
		...
		textArea.setBounds(176, 36, 281, 64);
		...
		textArea_2.setBounds(176, 120, 281, 67);
		studentTab.add(textArea_2);
		
		JLabel lblFeedback = new JLabel("System feedback");
		lblFeedback.setBounds(176, 22, 117, 14);
		studentTab.add(lblFeedback);
